...
echo "  5. Generate all main figures (1-6)"
echo "  6. Generate all supplementary figures (S1-S6)"
...
echo "Generating main figures (1-6) and supplementary figures (S1-S6)..."
...
echo "  • Figure 1: Coverage by field type"
echo "  • Figure 2: Elsevier publisher bias"
echo "  • Figure 3: Book publication bias"
echo "  • Figure 4: University adoption"
echo "  • Figure 5: Scopus vs OpenAlex rankings"
echo "  • Figure 6: Ranking change distribution"
echo ""
echo "Supplementary Figures (figures/):"
echo "  • Figure S1: Sample characteristics"
echo "  • Figure S2: Coverage distribution"
echo "  • Figure S3: Publisher breakdown"
echo "  • Figure S4: Regression diagnostics"
echo "  • Figure S5: Open access analysis"
echo "  • Figure S6: Extreme undercounting cases"
echo ""
