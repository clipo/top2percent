...
# Diagnostic forest-plot version saved to figures/bayesian/. The canonical
# Supplementary Figure S4 (bar chart) is produced by
# scripts/python/figureS4_prior_sensitivity.py from this same Table B4 CSV.
ggsave("figures/bayesian/FigureS4_prior_sensitivity_forest.pdf",
       fig_s12, width = 10, height = 6)
ggsave("figures/bayesian/FigureS4_prior_sensitivity_forest.png",
       fig_s12, width = 10, height = 6, dpi = 300)
cat("  Saved: figures/bayesian/FigureS4_prior_sensitivity_forest.pdf/png\n")
cat("  (Canonical Figure S4 is generated by scripts/python/figureS4_prior_sensitivity.py)\n")
...
cat("\nGenerated figures:\n")
cat("  - FigureS4_prior_sensitivity_forest.png/.pdf: forest-plot variant\n")
